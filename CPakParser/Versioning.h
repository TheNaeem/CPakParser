...
static_assert(EUnrealEngineObjectUE4Version::VER_UE4_AUTOMATIC_VERSION < (int32_t)EUnrealEngineObjectUE5Version::INITIAL_VERSION, "UE4 versioning must be lower than the start of UE5 versioning");

struct FPackageFileVersion
{
	FPackageFileVersion() = default;
	FPackageFileVersion(int32_t UE4Version, EUnrealEngineObjectUE5Version UE5Version)
