...
export module CPakParser.Localization;

export import CPakParser.Localization.Text;
...
export struct FLocalization : public ISerializableFile
{
	...
	void Serialize(FArchive& Ar) override // TODO: optimize this instead of making it 1:1 with UE source
	{
		FGuid Magic;
		Ar << Magic;
